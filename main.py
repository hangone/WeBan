...
if __name__ == "__main__":
    try:
        ...
        with open("config.json", "w", encoding="utf-8") as f:
            data = [{"tenant_name": "学校名称", "account": "用户名 1", "password": "密码 1", "study": True, "study_time": 15, "exam": False, "exam_use_time": 2000}]
    ...
    for config in configs:
        ...
        try:
            client = WeBanClient(account, password, tenant_name, study_time)
            client.run()
